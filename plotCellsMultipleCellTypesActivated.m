% plot cells on figure handle - flagging activated cells too
function plotCellsMultipleCellTypesActivated(x,cellType,cellRadii,activated,parentHandle)
  ...
  plot(xPos(activated),yPos(activated),'ro');
